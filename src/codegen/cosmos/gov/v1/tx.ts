...
export const MsgCancelProposalResponse = {
  ...
  fromSDK(object: MsgCancelProposalResponseSDKType): MsgCancelProposalResponse {
    return {
      proposalId: object?.proposal_id,
      canceledTime: object.canceled_time ? Timestamp.fromSDK(object.canceled_time) : undefined,
  ...
  toSDK(message: MsgCancelProposalResponse): MsgCancelProposalResponseSDKType {
    const obj: any = {};
    obj.proposal_id = message.proposalId;
    message.canceledTime !== undefined && (obj.canceled_time = message.canceledTime ? Timestamp.toSDK(message.canceledTime) : undefined);
  ...
  fromAmino(object: MsgCancelProposalResponseAmino): MsgCancelProposalResponse {
    return {
      proposalId: Long.fromString(object.proposal_id),
      canceledTime: object?.canceled_time ? Timestamp.fromAmino(object.canceled_time) : undefined,
